        ...
        <div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat" style="background-image: url('/dashboard/assets/bg-3.jpg');">
            <div class="login-form text-center p-7 position-relative overflow-hidden">
                ...
                <div class="d-flex flex-center mb-3">
                    <a href="#">
                        <img src="/assets/img/logo0.png" class="max-h-100px" alt=""/>
                    </a>
                </div>
                <!--end::Login Header-->
                ...
                <div class="login-signin">
                    <div class="mb-5">
                        <h3 class="mb-3">ورود به سیستم</h3>
                        <div class="text-muted font-weight-bold">سامانه مبادلات تجهیزات مازاد صنعت نفت، گاز و پتروشیمی</div>
                    </div>
                    <form class="form" method="POST" action="{{ route('login') }}" >
                        @csrf
                        <div class="form-group mb-5">
                            <input style="direction: rtl; text-align: right" class="form-control h-auto form-control-solid py-4 px-8 @error('email') is-invalid @enderror" type="text" placeholder="آدرس ایمیل" autofocus required name="email" value="{{ old('email') }}" autocomplete="off" />
                            @error('email')
                        ...
                        <div class="form-group d-flex flex-wrap justify-content-between align-items-center">
                            <a href="{{ route('password.request') }}" class="text-muted text-hover-primary">رمز عبور را فراموش کرده اید؟</a>
					...
					<span class="opacity-70 mr-4">
                        ...
                        <a href="/register" class="text-muted text-hover-primary font-weight-bold">عضویت در سامانه</a>
                    </div>
                </div>
            </div>
        </div>
