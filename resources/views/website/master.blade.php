...
<head>
    ...
    <link rel="stylesheet" id="colors" href="assets/css/colors/darkBlue.css" type="text/css">
</head>
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white fixed-top scrolling-navbar">
        <div class="container">
            <div class="navbar-header">
                ...
                <a href="/" class="navbar-brand"><img src="assets/img/logo0.png" alt="" />
            ...
            <div class="collapse navbar-collapse" id="main-navbar">
                <ul class="navbar-nav mr-auto w-100 justify-content-center">
                    ...
                    <li class="nav-item"><a class="nav-link" href="" >آخرین مزایدات</a></li>
                ...
                <div class="post-btn">
                    <a class="btn btn-common" href=""><i class="lni-pencil-alt"></i> عضویت / ورود در سامانه</a>
                </div>
            </div>
        </div>
